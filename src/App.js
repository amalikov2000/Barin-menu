...
const App = () => {
  ...
  const getMenuContent = () => {
    switch (activeTab) {
        ...
        return (
          <List
            ...
            dataSource={[
              ...
              { item: 'CAPRESE', ingredients: 'pomodoro cuore di bue, mozzarella fior di latte, pesto e basilico', price: '8,50 euro' },
              { item: 'VASILISA', ingredients: 'insalata misticanza, finocchio, ceci, cetrioli, pomodori secchi e scaglie di grana', price: '8,50 euro' },
              { item: 'VERDUROSA', ingredients: 'insalata misticanza, pomodorini, zucchine, melanzane, peperoni, avocado, broccoli, e grana', price: '8,50 euro' },
              { item: 'PHOCAONTAS', ingredients: 'insalata misticanza, bresaola, pomodorini, riccioli di finocchio, philadelphia e noci ', price: '10,00 euro' },
              { item: 'CLASSICA', ingredients: 'insalata misticanza, carote, pomodoro, tonno e mozzarella', price: '9,00 euro' },
              { item: 'CAESAR', ingredients: 'insalata misticanza,pomodorini, stracetti di pollo, bacon croccante,salsa cesar, grana a scaglie e crostini', price: '10,00 euro' },
              { item: 'FRESCA', ingredients: 'insalata misticanza, sfilaci, uova, zucchine grigliate, grana e olive', price: '9,00 euro' },
              { item: 'DELICATA', ingredients: 'insalata misticanza, cetriolo, arancia, gamberetti, avocado, e mais', price: '9,00 euro' },
              { item: 'DARIA', ingredients: ' insalata misticanza, carote, pomodorini, philadelphia, fesa di tacchino e semi di zucca', price: '9,00 euro' },
              { subheader: true, content: 'Snack' },
              { item: 'Tramezzini ', ingredients: 'Vari gusti', price: '2,50 euro' },
              { item: 'Piadina', ingredients: 'crudo serrano e mozzarella filante', price: '5.00 euro' },
              { item: 'Piadina', ingredients: 'Prosciutto cotto, pomodoro e mozarella', price: '5.00 euro' },
              { item: 'Piadina Integrale', ingredients: 'mozzarella, pomodoro, melanzane grigliate e grana', price: '5.00 euro' },
              { item: 'Piadina Integrale', ingredients: 'tacchino arrosto, philadelphia, pomodoro ramato e insalatina', price: '5.00 euro' },
              { item: 'Focaccia Genovese', ingredients: 'soppressa e fontina', price: '5.00 euro' },
              { item: 'Focaccia Genovese', ingredients: 'mozzarella, zucchine grigliate e pomodoro', price: '5.00 euro' },
              { item: 'Panino alla curcuma', ingredients: ' spianata calabra, rucola e formaggio', price: '5.00 euro' },
              { item: 'Tostone Classico', ingredients: 'Prosciutto cotto e fontina', price: '5.00 euro' },
              { item: 'Tostone ai Cereali', ingredients: 'zucchine e melanzane grligliati, spinaci e formaggio', price: '5.00 euro' },
              { item: 'Toast alla Curcuma', ingredients: 'Uovo sodo, avocado, bacon, pomodoro e insalata', price: '5.00 euro' },
            ]}
            renderItem={item => {
              if (item.subheader) {
                return (
      ...
      case '4':
        return <div>Dolce menu content</div>;
      case '5':
        return <div>Cafeteria menu content</div>;
      default:
        return null;
    }
  };
